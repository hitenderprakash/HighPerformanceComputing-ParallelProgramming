 ...
 * Assignment 3
 * Program: 1
 * code for craeting derived datatype in MPI and using MPI_Sendrecv
...
int main(int argc, char *argv[]){
	...
	MPI_Sendrecv(&buffer,1,MPI_Pars,left,0, &buffer2, 1, MPI_Pars, right, 0, MPI_COMM_WORLD,&status);
